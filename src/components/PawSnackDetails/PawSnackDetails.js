...
const PawSnackDetails = () => {
  ...
  const pawsnacks = [
    ...
    },
    {
      ...
      description:
        "Indulgee in the rich flavors of our Pawfect Chocolate Cupcake, made with premium ingredients for a delightful treat!",
  ...
  const pawsnack = pawsnacks.find((cake) => cake.id === parseInt(id));
  ...
  const handleView = (pawsnack) => {
    const price =
      pawsnack.off > 0
        ? Math.round(
          pawsnack.originalPrice - (pawsnack.originalPrice * pawsnack.off) / 100
        )
  ...
  const relatedProducts = pawsnacks.filter((item) => item.id !== parseInt(id));
    ...
    <div className="container cupcake-details">
      <div className="row">
        ...
        <div className="col-md-5">
          <div className="d-flex align-items-start">
            ...
            <div className="thumbnail-gallery me-3">
              {pawsnack.thumbnailImages.map((thumb, index) => (
                <img
                  key={index}
                  src={thumb}
            ...
            <div className="main-image">
              <img
                src={pawsnack.thumbnailImages[selectedIndex]}
                alt={pawsnack.name}
                className="img-fluid"
              />
            </div>
        ...
        <div className="col-md-7">
          <div className="details">
            ...
            <h1 className="product-title">{pawsnack.name}</h1>
            <div className="price-section">
              <span className="original-price-details">₹{pawsnack.originalPrice}</span>
              <span className="discounted-price">₹{discountedPrice}</span>
              <span className="free-shipping">& Free Shipping</span>
            </div>
            <p className="product-description">{pawsnack.description}</p>
      ...
      <div className="container my-5">
        ...
        <ul className="nav nav-tabs" role="tablist">
          ...
          <li className="nav-item">
            <a
              ...
              aria-selected="false"
            >
              Reviews ({pawsnack.reviews.length})
            </a>
          </li>
        </ul>
        ...
        <div className="tab-content mt-4">
          ...
          >
            <p className="description-text">{pawsnack.moredescription}</p>
          </div>
          ...
          >
            <ul
              ...
              style={{
                ...
                overflowY: pawsnack.reviews && pawsnack.reviews.length > 3 ? "auto" : "visible", // Add scroll if more than 3 reviews
              }}
            >
              {pawsnack.reviews && pawsnack.reviews.length > 0 ? (
                pawsnack.reviews.map((review) => ( // Show only first 3 reviews
                  <li
                    key={review.reviewId}
