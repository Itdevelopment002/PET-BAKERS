...
const CakeDetails = () => {
  ...
  const cakes = [
    ...
    },
    {
      ...
      description:
        "Indulge it in the rich flavors of our Pawfect Chocolate Cupcake, made with premium ingredients for a delightful treat!",
      moredescription: "Indulge it in the rich, velvety flavors of our Pawfect Chocolate Cupcake, crafted with the finest cocoa and premium ingredients for a truly decadent treat. Topped with a luscious swirl of chocolate frosting, each bite promises pure chocolate bliss. Perfect for any occasion, this delightful dessert is sure to satisfy your sweet cravings!",
      reviews: [
        {
          reviewId: 1,
          reviewName: "Emily John",
          reviewDate: "2024-12-20",
          reviewRating: 5,
          reviewDescription: "Absolutely loved it!! The texture and taste were perfect. Will order again.",
        },
  ...
  const relatedProducts = cakes.filter((item) => item.id !== parseInt(id));
    ...
    <div className="container cupcake-details">
        ...
        <div className="col-md-5">
          <div className="d-flex align-items-start">
            ...
            <div className="thumbnail-gallery me-3">
              {cake.thumbnailImages.map((thumb, index) => (
                <img
                  key={index}
                  src={thumb}
            ...
            <div className="main-image">
              <img
                src={cake.thumbnailImages[selectedIndex]}
                alt={cake.name}
                className="img-fluid"
              />
            </div>
        ...
        <div className="col-md-7">
          <div className="details">
            ...
            <div className="price-section">
              <span className="original-price-details">₹{cake.originalPrice}</span>
      ...
      <div className="container my-5">
        ...
        <div className="tab-content mt-4">
          ...
          >
            <p className="description-text">{cake.moredescription}</p>
          </div>
          ...
          >
            <ul
              ...
              style={{
                ...
                overflowY: cake.reviews && cake.reviews.length > 3 ? "auto" : "visible", // Add scroll if more than 3 reviews
              }}
            >
              {cake.reviews && cake.reviews.length > 0 ? (
                cake.reviews.map((review) => ( // Show only first 3 reviews
                  <li
                    key={review.reviewId}
